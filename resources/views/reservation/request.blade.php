        ...
        <form method="post" action="{{ route('requestPost', ['room' => $room->getName(), 'date' => $timeslot->format('Y-m-d\TH')]) }}">
            ...
            <div class="form-group row{{ $errors->has('recur') ? ' has-danger' : '' }}">
                ...
                <div class="col-xs-9 col-md-3">
                    <div class="input-group">
                        <input class="form-control{{ $errors->has('recur') ? ' form-control-danger' : '' }}" type="number" name="recur" min="1" max="{{\App\Http\Controllers\ReservationController::MAX_RECUR}}" value="1" id="inputRecur">
            ...
            <div class="form-group row">
                <div class="offset-sm-2 col-sm-10">
                    <a href="{{ route('reservationSessionCancel', []) }}" class="btn btn-secondary"><i class="fa fa-chevron-left" aria-hidden="true"></i> Cancel</a>
